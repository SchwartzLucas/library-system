...
public class Emprestimo {
    ...
    @Column(name = "data_emprestimo", columnDefinition = "TIMESTAMP")
    private LocalDateTime dataEmprestimo;

    @Column(name = "data_previsa_devolucao", columnDefinition = "TIMESTAMP")
    private LocalDateTime dataPrevistaDevolucao;

    @Column(name = "data_devolucao_realizada", columnDefinition = "TIMESTAMP")
